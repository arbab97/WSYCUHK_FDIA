...
do
  ...
  do
    ...
    do
      ...
      --data_dir "/content/drive/MyDrive/openUAE/locational detection/data_ieee14_118_locational_detection/data14_1.mat" \
      --output_dir "/content/drive/MyDrive/openUAE/locational detection/tradeoff_analysis/IEEE14/" \
      --layers "$layer"\
      --neurons "$neuron"\
      --shape 19
